# Descente - 프리미엄 쇼핑몰 프로젝트

## 프로젝트 개요

### 프로젝트 주제
**Descente 쇼핑몰 웹사이트** - 사용자 친화적인 인터페이스와 완전한 반응형 디자인을 갖춘 플랫폼
...
### 주요 타겟 사용자
- **주 사용자**: Descente 를 원하는 일반 소비자 (20-50대)
...
<img src="logo.svg" alt="Descente 로고">
